...
Source0:	http://resources.ovirt.org/pub/src/ovirt-ansible-collection/ovirt-ansible-collection-1.6.5.tar.gz
...
%changelog
* Mon Oct 19 2021 Martin Necas <mnecas@redhat.com> - 1.6.5-1
